...
public class AdminPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Capacity Filled");
        ...
        jButton2.setText("Inform Worker");
        ...
        jPanel2.setBounds(0, 80, 590, 490);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double filled;
        String status;
        garbagePit g = new garbagePit();
        int l, b, h;
        l = Integer.parseInt(jTextField1.getText());
        b = Integer.parseInt(jTextField2.getText());
        h = Integer.parseInt(jTextField3.getText());
        g.setDimension(l,b,h);
        vol = g.volume();
        cap = Integer.parseInt(jTextField4.getText());
        filled = cap/(double)vol;
        if(g.status(cap) == 1)
        {
            status = "FILLED";
            jProgressBar1.setValue((int)(filled*100) );
        }
        else
        {
            status = "NOT FILLED";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        informWorker i = new informWorker();
        i.setVisible(true);
        this.setVisible(false);
        this.dispose();
